export const boardTemplates = {
  ...
  <div class="container-add-task-board"> 
    ...
    <h1 class="page-title page-titel-add-task-modal" id="addTaskTitle">Add Task</h1>
    <div class="form-wrapper scrollable">
      
        <div class="left-section modal-space">
          <div class="form-group">
    ...
    <div class="button-group">
      ...
      <div class="buttons buttons-add-task-modal">
